...
# UI - Tab 3: Europe & Central Asia
# 
### ------------------------------------

### Function
EuropeCentralAsia = function(flag_state_choices)
  fluidPage(
                     ...
                     column(4, id = "left-column-real",
                            ...
                            column(12, id = "lr-spaced-div",
                                   ...
                                   column(12, id = "t-spaced-div",
                                          ...
                                          tags$button(id = "europe_central_asia_return_to_region",
                                   ...
                                   column(12, id = "b-spaced-div",
                                          ...
                                          uiOutput("europe_central_asia_eez_select")
            ...
            column(8, id = "right-column",
                   ...
                   column(12,
                          ...
                          # tabBox
                          tabBox(width = 12, id = "europe-central-asia-results-tabs", 
                                 
                                 ### --------------------------
                                 ### Tab # 1  - Stats overview
                                 ### --------------------------
                                 
                                 tabPanel(value = "europe-central-asia-summary",
                                          ...
                                          tagList(
                                            ...
                                            tags$b("Summary"),
                                            # Info button
                                            tags$button(id = "europe_central_asia_info_summary",
                                          ...
                                          column(12, id = "tblr-spaced-div",
                                                 ...
                                                 # Interactive text
                                                 uiOutput("europe_central_asia_country_profile")
                                 ...
                                 tabPanel(value = "europe-central-asia-origins",
                                          ...
                                          tagList(
                                            ...
                                            # Info button
                                            tags$button(id = "europe_central_asia_info_vessel_origins",
                                                        class = "btn action-button info-button",
                                                        icon("info"))
                                            ),
                                          ...
                                          column(12, id = "lr-spaced-div",
                                                 ...
                                                 column(12, id = "t-spaced-div",
                                                        ...
                                                        fluidRow(
                                                          ...
                                                          column(6, align = "center",
                                                                 ...
                                                                 selectizeInput(
                                                                   "europe_central_asia_vessel_origins_fill",
                                                          ...
                                                          column(6, align = "center",
                                                                 ...
                                                                 radioButtons(
                                                                   "europe_central_asia_vessel_origins_fill_rescale",
                                                 ...
                                                 column(12, id = "b-spaced-div",
                                                        ...
                                                        leafletOutput("europe_central_asia_vessel_origins_map", width = "auto")
                                 ...
                                 tabPanel(value = "europe-central-asia-effort",
                                          ...
                                          tagList(
                                            ...
                                            # Info button
                                            tags$button(id = "europe_central_asia_info_effort",
                                                        class = "btn action-button info-button",
                                                        icon("info"))
                                          ),
                                                 ...
                                                 column(12, id = "t-spaced-div",
                                                        ...
                                                        fluidRow(
                                                          ...
                                                          column(6, align = "center",
                                                                 ...
                                                                 selectizeInput(
                                                                   "europe_central_asia_effort_select_flag_state",
                                                 ...
                                                 column(12, id = "b-spaced-div",
                                                        ...
                                                        fluidRow(
                                                          ...
                                                          column(6, align = "center",
                                                                 ...
                                                                 plotOutput("europe_central_asia_effort_map_all", 
                                                                            width = "auto"),
                                                                 
                                                                 uiOutput("europe_central_asia_effort_summary_all")
                                                                 
                                                          ),
                                                          # Selected flag state
                                                          column(6, align = "center",
                                                                 
                                                                 plotOutput("europe_central_asia_effort_map_selected",
                                                                            width = "auto"),
                                                                 
                                                                 uiOutput("europe_central_asia_effort_summary_selected")
                                 ...
                                 tabPanel(value = "europe-central-asia-subsidies",
                                          ...
                                          tagList(
                                            ...
                                            # Info button
                                            tags$button(id = "europe_central_asia_info_subsidies",
                                                        class = "btn action-button info-button",
                                                        icon("info"))
                                            ),
                                                 ...
                                                 column(12, id = "t-spaced-div",
                                                        ...
                                                        fluidRow(
                                                          ...
                                                          column(6, align = "center",
                                                                 ...
                                                                 selectizeInput(
                                                                   "europe_central_asia_subsidies_select_flag_state",
                                                                   label = "Filter fishing activity by flag state...",
                                                                   choices = c("Select a flag state...", flag_state_choices),
                                                                   selected = "Select a flag state...",
                                                                   width = "100%"
                                                 ...
                                                 column(12, id = "b-spaced-div",
                                                        ...
                                                        fluidRow(
                                                          ...
                                                          column(6, align = "center",
                                                                 ...
                                                                 plotOutput("europe_central_asia_subsidies_map_all", 
                                                                            width = "auto"),
                                                                 
                                                                 uiOutput("europe_central_asia_subsidies_summary_all")
                                                          ...
                                                          column(6, align = "center",
                                                                 ...
                                                                 plotOutput("europe_central_asia_subsidies_map_selected",
                                                                            width = "auto"),
                                                                 
                                                                 uiOutput("europe_central_asia_subsidies_summary_selected")
