...
# This is a duplicate of the region page layout function, just with some minor tweaks so I can more easily adjust for the high seas areas. 

HSPageLayout <- function(region_name, 
                         region_name_long,
