...
sql4 <- paste0(
 ...
 SELECT
    ...
    SUM(fishing_hours * engine_power_kw) as fishing_KWh,
    SUM(fishing_hours * engine_power_kw * subs_per_fishing_KWh) as subs
  FROM
    selected_vi 
  LEFT JOIN
    eez_info
  USING
    (year, ssvid, eez_code)
  LEFT JOIN
    `ucsb-gfw.subsidy_atlas.subsidy_rates_flag`
  USING
    (flag)
  LEFT JOIN
    eez_lookup
