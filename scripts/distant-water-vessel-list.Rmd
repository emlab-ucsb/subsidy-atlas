...
# Write to disk
name <- paste0("top_", number_of_top_countries_flag, "_flag_states")
write_csv(flag_state_ranking, paste0(results_dir, name, ".csv"))
```
...
# Write to disk
name2 <- paste0("top_", number_of_top_countries_eez, "_eezs")
write_csv(EEZ_ranking, paste0(results_dir, name2, ".csv"))
```
