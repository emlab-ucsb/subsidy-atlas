...
ACP_dir <- here::here("results", "ACP_EEZ_results/")
if (dir.exists(ACP_dir) == F) {
  dir.create(ACP_dir, recursive = T)
}

ACP_app_dir <- here::here("SubsidyAtlasACP", "data" ,"ACP_EEZ_results/")
if (dir.exists(ACP_app_dir) == F) {
  dir.create(ACP_app_dir, recursive = T)
}

pdf_flag_dir <- here::here("results", "pdf_flag_results/")
if (dir.exists(pdf_flag_dir) == F) {
  dir.create(pdf_flag_dir, recursive = T)
}

pdf_eez_dir <- here::here("results", "pdf_eez_results/")
if (dir.exists(pdf_eez_dir) == F) {
  dir.create(pdf_eez_dir, recursive = T)
}
...
dw_effort_renamed$eez_sovereign2_iso3 <- as.character(dw_effort_renamed$eez_sovereign2_iso3)
...
dw_effort_renamed$eez_sovereign3_iso3 <- as.character(dw_effort_renamed$eez_sovereign3_iso3)
