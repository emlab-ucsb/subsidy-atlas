...
A secondary purpose of this tool is to show distant water fishing effort occuring on the high seas. We separate out the vessels partaking in distant water fishing here. 

```{r}
vessel_list_hs <- vessel_list_raw %>%
  dplyr::filter(eez_id == 0000)
