...
```{r}
flag_eez_fao_summary <- vessel_list_raw %>%
  group_by(eez_id, flag_iso3, flag_sovereign_iso3, is_EU) %>%
...
This is why we have created files with our EEZ and country polygons duplicated and extended such that the total extent ranges from -540 to 540 degrees. We can then clip these to the appropriate extents for each of our seven regions, such that no polygons (and connectivity) lines get bifurcated. 
