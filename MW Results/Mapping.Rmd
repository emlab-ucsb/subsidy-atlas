...
plot_map_CHN <- ggplot()+
  ...
  geom_sf(data = EEZ_final_results_CHN, col = "orange") #%>% dplyr::filter(flag =="CHN"), col = "orange")
...
plot_map_ARG <- ggplot()+
  geom_sf(data = EEZ_map, fill = "white", alpha = 0.5)+
  geom_sf(data = world_map, fill = "white")+
  geom_sf(data = world_map %>% dplyr::filter(iso3 == "ARG"), fill = "red")+ 
  geom_sf(data = eez_filtered_ARG %>% dplyr::filter(ez_hs_c == "USA"), fill = "blue", alpha = 0.5) +
  geom_sf(data = EEZ_final_results_ARG %>% dplyr::filter(eez_iso3 == "USA"), col = "orange") #%>% dplyr::filter(flag =="CHN"), col
