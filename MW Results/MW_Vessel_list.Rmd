...
#table <- table_all %>%
 ...
 #
# list_of_countries <- table$country
# 
# for(i in 1:length(list_of_countries)){
#   
#   country_dat <- table %>%
#     filter(country == list_of_countries[1])
#   
# }
...
png(filename = "flag_vessel_number_table.png", width=480,height=480,bg = "white")
...
png(filename = "flag_totaleffort_table.png", width=480,height=480,bg = "white")
...
png(filename = "flag_totalkwhr_table.png", width=480,height=480,bg = "white")
...
png(filename = "EEZ_vessel_number_table.png", width=480,height=480,bg = "white")
...
png(filename = "EEZ_totaleffort_table.png", width=480,height=480,bg = "white")
...
png(filename = "EEZ_totalkwhr_table.png", width=480,height=480,bg = "white")
