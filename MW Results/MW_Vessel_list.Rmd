...
```{r Combining number of vessels and total effort}

## Combining number of vessels and total effort

final_results <- merge(vessel_numbersummary, vessel_effortsummary, by = "flag") %>% 
  arrange(desc(total_vessels))


#View(final_results)

write_csv(final_results, "final_vessels_effort.csv")
